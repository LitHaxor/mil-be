...
export class SparePartController {
  ...
  @ApiOperation({
    ...
    description: 'Create a new spare part template',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve all spare parts, optionally filtered by equipment type',
  })
  @ApiQuery({
    name: 'equipmentType',
    required: false,
  ...
  @ApiQuery({
    name: 'name',
    required: true,
    description: 'Search term for spare part name',
  })
  ...
  @ApiOperation({
    ...
    description: 'Retrieve a specific spare part by ID',
  })
  ...
  @ApiOperation({
    ...
    description: 'Update a spare part by ID',
  })
  @ApiParam({ name: 'id', description: 'Spare part ID' })
  ...
  @ApiOperation({
    ...
    description: 'Delete a spare part by ID',
  })
  @ApiParam({ name: 'id', description: 'Spare part ID' })
